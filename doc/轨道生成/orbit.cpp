...
{
	p.tmp=p.r0*p.r0*sqrt((p.epsilon+1)/(GM*p.r0));
}
...
用地球的v反推为：GM=134961911110000000000
地球：
\epsilon=0.0167086
r_m=1.471e11
r0=149557835060
...
//calc_time(2pi)=31554997.86633654969277017306216979730469355597558951845713
//calc_theta(T)=6.28383432802419446893775191578208822284321097985110
*/
